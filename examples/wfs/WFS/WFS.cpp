...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("0/x", &fHslider17, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("0/y", &fHslider16, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("1/x", &fHslider15, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("1/y", &fHslider14, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("2/x", &fHslider13, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("2/y", &fHslider12, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("3/x", &fHslider11, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("3/y", &fHslider10, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("4/x", &fHslider9, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("4/y", &fHslider8, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("5/x", &fHslider7, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("5/y", &fHslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("6/x", &fHslider5, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("6/y", &fHslider4, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("7/x", &fHslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("7/y", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		...
		ui_interface->addHorizontalSlider("spacing", &fHslider3, FAUSTFLOAT(0.2f), FAUSTFLOAT(0.05f), FAUSTFLOAT(0.45f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 2.0f * float(fHslider1);
		float fSlow2 = fConst1 * float(fHslider2);
		float fSlow3 = float(fHslider3);
		float fSlow4 = fConst5 * fSlow3 + 1.0f;
		...
		float fSlow13 = fConst1 * float(fHslider12);
		float fSlow14 = fConst1 * float(fHslider13);
		float fSlow15 = fConst1 * float(fHslider14);
		float fSlow16 = fConst1 * float(fHslider15);
		float fSlow17 = fConst1 * float(fHslider16);
		float fSlow18 = fConst1 * float(fHslider17);
		float fSlow19 = fSlow1 + 1.0f;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec0[0] = fSlow0 + fConst2 * fRec0[1];
			float fTemp0 = 5.0f * fRec0[0];
			float fTemp1 = mydsp_faustpower2_f(fTemp0);
			fRec1[0] = fSlow2 + fConst2 * fRec1[1];
			float fTemp2 = 15.0f * fRec1[0];
			float fTemp3 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp2 - fSlow1)) + fTemp1);
			float fTemp4 = fConst3 * (fTemp3 - fTemp0);
			float fTemp5 = std::floor(fTemp4);
			float fTemp6 = mydsp_faustpower2_f(2.0f / (fTemp3 + 2.0f));
			float fTemp7 = std::tan(fConst4 * (1.5e+04f * fTemp6 + 5e+03f));
			float fTemp8 = 1.0f / fTemp7;
			float fTemp9 = (fTemp8 + 1.4142135f) / fTemp7 + 1.0f;
			float fTemp10 = float(input7[i0]);
			fRec2[0] = fTemp10 * fTemp6 - (fRec2[2] * ((fTemp8 + -1.4142135f) / fTemp7 + 1.0f) + 2.0f * fRec2[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp7))) / fTemp9;
			float fTemp11 = (fRec2[2] + fRec2[0] + 2.0f * fRec2[1]) / fTemp9;
			fVec0[IOTA0 & 4095] = fTemp11;
			int iTemp12 = int(fTemp4);
			fRec3[0] = fSlow5 + fConst2 * fRec3[1];
			float fTemp13 = 5.0f * fRec3[0];
			float fTemp14 = mydsp_faustpower2_f(fTemp13);
			fRec4[0] = fSlow6 + fConst2 * fRec4[1];
			float fTemp15 = 15.0f * fRec4[0];
			float fTemp16 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp15 - fSlow1)) + fTemp14);
			float fTemp17 = fConst3 * (fTemp16 - fTemp13);
			float fTemp18 = std::floor(fTemp17);
			float fTemp19 = mydsp_faustpower2_f(2.0f / (fTemp16 + 2.0f));
			float fTemp20 = std::tan(fConst4 * (1.5e+04f * fTemp19 + 5e+03f));
			float fTemp21 = 1.0f / fTemp20;
			float fTemp22 = (fTemp21 + 1.4142135f) / fTemp20 + 1.0f;
			float fTemp23 = float(input6[i0]);
			fRec5[0] = fTemp23 * fTemp19 - (fRec5[2] * ((fTemp21 + -1.4142135f) / fTemp20 + 1.0f) + 2.0f * fRec5[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp20))) / fTemp22;
			float fTemp24 = (fRec5[2] + fRec5[0] + 2.0f * fRec5[1]) / fTemp22;
			fVec1[IOTA0 & 4095] = fTemp24;
			int iTemp25 = int(fTemp17);
			fRec6[0] = fSlow7 + fConst2 * fRec6[1];
			float fTemp26 = 5.0f * fRec6[0];
			float fTemp27 = mydsp_faustpower2_f(fTemp26);
			fRec7[0] = fSlow8 + fConst2 * fRec7[1];
			float fTemp28 = 15.0f * fRec7[0];
			float fTemp29 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp28 - fSlow1)) + fTemp27);
			float fTemp30 = fConst3 * (fTemp29 - fTemp26);
			float fTemp31 = std::floor(fTemp30);
			float fTemp32 = mydsp_faustpower2_f(2.0f / (fTemp29 + 2.0f));
			float fTemp33 = std::tan(fConst4 * (1.5e+04f * fTemp32 + 5e+03f));
			float fTemp34 = 1.0f / fTemp33;
			float fTemp35 = (fTemp34 + 1.4142135f) / fTemp33 + 1.0f;
			float fTemp36 = float(input5[i0]);
			fRec8[0] = fTemp36 * fTemp32 - (fRec8[2] * ((fTemp34 + -1.4142135f) / fTemp33 + 1.0f) + 2.0f * fRec8[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp33))) / fTemp35;
			float fTemp37 = (fRec8[2] + fRec8[0] + 2.0f * fRec8[1]) / fTemp35;
			fVec2[IOTA0 & 4095] = fTemp37;
			int iTemp38 = int(fTemp30);
			fRec9[0] = fSlow9 + fConst2 * fRec9[1];
			float fTemp39 = 5.0f * fRec9[0];
			float fTemp40 = mydsp_faustpower2_f(fTemp39);
			fRec10[0] = fSlow10 + fConst2 * fRec10[1];
			float fTemp41 = 15.0f * fRec10[0];
			float fTemp42 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp41 - fSlow1)) + fTemp40);
			float fTemp43 = fConst3 * (fTemp42 - fTemp39);
			float fTemp44 = std::floor(fTemp43);
			float fTemp45 = mydsp_faustpower2_f(2.0f / (fTemp42 + 2.0f));
			float fTemp46 = std::tan(fConst4 * (1.5e+04f * fTemp45 + 5e+03f));
			float fTemp47 = 1.0f / fTemp46;
			float fTemp48 = (fTemp47 + 1.4142135f) / fTemp46 + 1.0f;
			float fTemp49 = float(input4[i0]);
			fRec11[0] = fTemp49 * fTemp45 - (fRec11[2] * ((fTemp47 + -1.4142135f) / fTemp46 + 1.0f) + 2.0f * fRec11[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp46))) / fTemp48;
			float fTemp50 = (fRec11[2] + fRec11[0] + 2.0f * fRec11[1]) / fTemp48;
			fVec3[IOTA0 & 4095] = fTemp50;
			int iTemp51 = int(fTemp43);
			fRec12[0] = fSlow11 + fConst2 * fRec12[1];
			float fTemp52 = 5.0f * fRec12[0];
			float fTemp53 = mydsp_faustpower2_f(fTemp52);
			fRec13[0] = fSlow12 + fConst2 * fRec13[1];
			float fTemp54 = 15.0f * fRec13[0];
			float fTemp55 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp54 - fSlow1)) + fTemp53);
			float fTemp56 = fConst3 * (fTemp55 - fTemp52);
			float fTemp57 = std::floor(fTemp56);
			float fTemp58 = mydsp_faustpower2_f(2.0f / (fTemp55 + 2.0f));
			float fTemp59 = std::tan(fConst4 * (1.5e+04f * fTemp58 + 5e+03f));
			float fTemp60 = 1.0f / fTemp59;
			float fTemp61 = (fTemp60 + 1.4142135f) / fTemp59 + 1.0f;
			float fTemp62 = float(input3[i0]);
			fRec14[0] = fTemp62 * fTemp58 - (fRec14[2] * ((fTemp60 + -1.4142135f) / fTemp59 + 1.0f) + 2.0f * fRec14[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp59))) / fTemp61;
			float fTemp63 = (fRec14[2] + fRec14[0] + 2.0f * fRec14[1]) / fTemp61;
			fVec4[IOTA0 & 4095] = fTemp63;
			int iTemp64 = int(fTemp56);
			fRec15[0] = fSlow13 + fConst2 * fRec15[1];
			float fTemp65 = 5.0f * fRec15[0];
			float fTemp66 = mydsp_faustpower2_f(fTemp65);
			fRec16[0] = fSlow14 + fConst2 * fRec16[1];
			float fTemp67 = 15.0f * fRec16[0];
			float fTemp68 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp67 - fSlow1)) + fTemp66);
			float fTemp69 = fConst3 * (fTemp68 - fTemp65);
			float fTemp70 = std::floor(fTemp69);
			float fTemp71 = mydsp_faustpower2_f(2.0f / (fTemp68 + 2.0f));
			float fTemp72 = std::tan(fConst4 * (1.5e+04f * fTemp71 + 5e+03f));
			float fTemp73 = 1.0f / fTemp72;
			float fTemp74 = (fTemp73 + 1.4142135f) / fTemp72 + 1.0f;
			float fTemp75 = float(input2[i0]);
			fRec17[0] = fTemp75 * fTemp71 - (fRec17[2] * ((fTemp73 + -1.4142135f) / fTemp72 + 1.0f) + 2.0f * fRec17[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp72))) / fTemp74;
			float fTemp76 = (fRec17[2] + fRec17[0] + 2.0f * fRec17[1]) / fTemp74;
			fVec5[IOTA0 & 4095] = fTemp76;
			int iTemp77 = int(fTemp69);
			fRec18[0] = fSlow15 + fConst2 * fRec18[1];
			float fTemp78 = 5.0f * fRec18[0];
			float fTemp79 = mydsp_faustpower2_f(fTemp78);
			fRec19[0] = fSlow16 + fConst2 * fRec19[1];
			float fTemp80 = 15.0f * fRec19[0];
			float fTemp81 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp80 - fSlow1)) + fTemp79);
			float fTemp82 = fConst3 * (fTemp81 - fTemp78);
			float fTemp83 = std::floor(fTemp82);
			float fTemp84 = mydsp_faustpower2_f(2.0f / (fTemp81 + 2.0f));
			float fTemp85 = std::tan(fConst4 * (1.5e+04f * fTemp84 + 5e+03f));
			float fTemp86 = 1.0f / fTemp85;
			float fTemp87 = (fTemp86 + 1.4142135f) / fTemp85 + 1.0f;
			float fTemp88 = float(input1[i0]);
			fRec20[0] = fTemp88 * fTemp84 - (fRec20[2] * ((fTemp86 + -1.4142135f) / fTemp85 + 1.0f) + 2.0f * fRec20[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp85))) / fTemp87;
			float fTemp89 = (fRec20[2] + fRec20[0] + 2.0f * fRec20[1]) / fTemp87;
			fVec6[IOTA0 & 4095] = fTemp89;
			int iTemp90 = int(fTemp82);
			fRec21[0] = fSlow17 + fConst2 * fRec21[1];
			float fTemp91 = 5.0f * fRec21[0];
			float fTemp92 = mydsp_faustpower2_f(fTemp91);
			fRec22[0] = fSlow18 + fConst2 * fRec22[1];
			float fTemp93 = 15.0f * fRec22[0];
			float fTemp94 = std::sqrt(mydsp_faustpower2_f(fSlow3 * (fTemp93 - fSlow1)) + fTemp92);
			float fTemp95 = mydsp_faustpower2_f(2.0f / (fTemp94 + 2.0f));
			float fTemp96 = std::tan(fConst4 * (1.5e+04f * fTemp95 + 5e+03f));
			float fTemp97 = 1.0f / fTemp96;
			float fTemp98 = (fTemp97 + 1.4142135f) / fTemp96 + 1.0f;
			float fTemp99 = float(input0[i0]);
			fRec23[0] = fTemp99 * fTemp95 - (fRec23[2] * ((fTemp97 + -1.4142135f) / fTemp96 + 1.0f) + 2.0f * fRec23[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp96))) / fTemp98;
			float fTemp100 = (fRec23[2] + fRec23[0] + 2.0f * fRec23[1]) / fTemp98;
			fVec7[IOTA0 & 4095] = fTemp100;
			float fTemp101 = fConst3 * (fTemp94 - fTemp91);
			int iTemp102 = int(fTemp101);
			float fTemp103 = std::floor(fTemp101);
			output0[i0] = FAUSTFLOAT((fTemp4 - fTemp5) * fVec0[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp12 + 1))))) & 4095] + (fTemp17 - fTemp18) * fVec1[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp25 + 1))))) & 4095] + (fTemp30 - fTemp31) * fVec2[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp38 + 1))))) & 4095] + (fTemp43 - fTemp44) * fVec3[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp51 + 1))))) & 4095] + (fTemp56 - fTemp57) * fVec4[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp64 + 1))))) & 4095] + (fTemp69 - fTemp70) * fVec5[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp77 + 1))))) & 4095] + (fTemp82 - fTemp83) * fVec6[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp90 + 1))))) & 4095] + fVec7[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp102))))) & 4095] * (fTemp103 + (1.0f - fTemp101)) + (fTemp101 - fTemp103) * fVec7[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp102 + 1))))) & 4095] + fVec6[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp90))))) & 4095] * (fTemp83 + (1.0f - fTemp82)) + fVec5[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp77))))) & 4095] * (fTemp70 + (1.0f - fTemp69)) + fVec4[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp64))))) & 4095] * (fTemp57 + (1.0f - fTemp56)) + fVec3[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp51))))) & 4095] * (fTemp44 + (1.0f - fTemp43)) + fVec2[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp38))))) & 4095] * (fTemp31 + (1.0f - fTemp30)) + fVec1[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp25))))) & 4095] * (fTemp18 + (1.0f - fTemp17)) + fVec0[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp12))))) & 4095] * (fTemp5 + (1.0f - fTemp4)));
			float fTemp104 = std::sqrt(fTemp14 + mydsp_faustpower2_f(fSlow3 * (fTemp15 + -1.0f - fSlow1)));
			float fTemp105 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp104 + 2.0f)) + 5e+03f));
			float fTemp106 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp14 + mydsp_faustpower2_f(fSlow3 * (fTemp15 - fSlow19))) + 2.0f));
			float fTemp107 = std::tan(fConst4 * (1.5e+04f * fTemp106 + 5e+03f));
			float fTemp108 = 1.0f / fTemp107;
			fRec24[0] = fTemp23 * fTemp106 - (fRec24[2] * ((fTemp108 + -1.4142135f) / fTemp107 + 1.0f) + 2.0f * fRec24[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp107))) / ((fTemp108 + 1.4142135f) / fTemp107 + 1.0f);
			float fTemp109 = (fRec24[2] + fRec24[0] + 2.0f * fRec24[1]) / ((1.0f / fTemp105 + 1.4142135f) / fTemp105 + 1.0f);
			fVec8[IOTA0 & 4095] = fTemp109;
			float fTemp110 = fConst3 * (fTemp104 - fTemp13);
			int iTemp111 = int(fTemp110);
			float fTemp112 = std::floor(fTemp110);
			float fTemp113 = std::sqrt(fTemp1 + mydsp_faustpower2_f(fSlow3 * (fTemp2 + -1.0f - fSlow1)));
			float fTemp114 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp113 + 2.0f)) + 5e+03f));
			float fTemp115 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp1 + mydsp_faustpower2_f(fSlow3 * (fTemp2 - fSlow19))) + 2.0f));
			float fTemp116 = std::tan(fConst4 * (1.5e+04f * fTemp115 + 5e+03f));
			float fTemp117 = 1.0f / fTemp116;
			fRec25[0] = fTemp10 * fTemp115 - (fRec25[2] * ((fTemp117 + -1.4142135f) / fTemp116 + 1.0f) + 2.0f * fRec25[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp116))) / ((fTemp117 + 1.4142135f) / fTemp116 + 1.0f);
			float fTemp118 = (fRec25[2] + fRec25[0] + 2.0f * fRec25[1]) / ((1.0f / fTemp114 + 1.4142135f) / fTemp114 + 1.0f);
			fVec9[IOTA0 & 4095] = fTemp118;
			float fTemp119 = fConst3 * (fTemp113 - fTemp0);
			int iTemp120 = int(fTemp119);
			float fTemp121 = std::floor(fTemp119);
			float fTemp122 = std::sqrt(fTemp27 + mydsp_faustpower2_f(fSlow3 * (fTemp28 + -1.0f - fSlow1)));
			float fTemp123 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp122 + 2.0f)) + 5e+03f));
			float fTemp124 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp27 + mydsp_faustpower2_f(fSlow3 * (fTemp28 - fSlow19))) + 2.0f));
			float fTemp125 = std::tan(fConst4 * (1.5e+04f * fTemp124 + 5e+03f));
			float fTemp126 = 1.0f / fTemp125;
			fRec26[0] = fTemp36 * fTemp124 - (fRec26[2] * ((fTemp126 + -1.4142135f) / fTemp125 + 1.0f) + 2.0f * fRec26[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp125))) / ((fTemp126 + 1.4142135f) / fTemp125 + 1.0f);
			float fTemp127 = (fRec26[2] + fRec26[0] + 2.0f * fRec26[1]) / ((1.0f / fTemp123 + 1.4142135f) / fTemp123 + 1.0f);
			fVec10[IOTA0 & 4095] = fTemp127;
			float fTemp128 = fConst3 * (fTemp122 - fTemp26);
			int iTemp129 = int(fTemp128);
			float fTemp130 = std::floor(fTemp128);
			float fTemp131 = std::sqrt(fTemp40 + mydsp_faustpower2_f(fSlow3 * (fTemp41 + -1.0f - fSlow1)));
			float fTemp132 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp131 + 2.0f)) + 5e+03f));
			float fTemp133 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp40 + mydsp_faustpower2_f(fSlow3 * (fTemp41 - fSlow19))) + 2.0f));
			float fTemp134 = std::tan(fConst4 * (1.5e+04f * fTemp133 + 5e+03f));
			float fTemp135 = 1.0f / fTemp134;
			fRec27[0] = fTemp49 * fTemp133 - (fRec27[2] * ((fTemp135 + -1.4142135f) / fTemp134 + 1.0f) + 2.0f * fRec27[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp134))) / ((fTemp135 + 1.4142135f) / fTemp134 + 1.0f);
			float fTemp136 = (fRec27[2] + fRec27[0] + 2.0f * fRec27[1]) / ((1.0f / fTemp132 + 1.4142135f) / fTemp132 + 1.0f);
			fVec11[IOTA0 & 4095] = fTemp136;
			float fTemp137 = fConst3 * (fTemp131 - fTemp39);
			int iTemp138 = int(fTemp137);
			float fTemp139 = std::floor(fTemp137);
			float fTemp140 = std::sqrt(fTemp53 + mydsp_faustpower2_f(fSlow3 * (fTemp54 + -1.0f - fSlow1)));
			float fTemp141 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp140 + 2.0f)) + 5e+03f));
			float fTemp142 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp53 + mydsp_faustpower2_f(fSlow3 * (fTemp54 - fSlow19))) + 2.0f));
			float fTemp143 = std::tan(fConst4 * (1.5e+04f * fTemp142 + 5e+03f));
			float fTemp144 = 1.0f / fTemp143;
			fRec28[0] = fTemp62 * fTemp142 - (fRec28[2] * ((fTemp144 + -1.4142135f) / fTemp143 + 1.0f) + 2.0f * fRec28[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp143))) / ((fTemp144 + 1.4142135f) / fTemp143 + 1.0f);
			float fTemp145 = (fRec28[2] + fRec28[0] + 2.0f * fRec28[1]) / ((1.0f / fTemp141 + 1.4142135f) / fTemp141 + 1.0f);
			fVec12[IOTA0 & 4095] = fTemp145;
			float fTemp146 = fConst3 * (fTemp140 - fTemp52);
			int iTemp147 = int(fTemp146);
			float fTemp148 = std::floor(fTemp146);
			float fTemp149 = std::sqrt(fTemp66 + mydsp_faustpower2_f(fSlow3 * (fTemp67 + -1.0f - fSlow1)));
			float fTemp150 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp149 + 2.0f)) + 5e+03f));
			float fTemp151 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp66 + mydsp_faustpower2_f(fSlow3 * (fTemp67 - fSlow19))) + 2.0f));
			float fTemp152 = std::tan(fConst4 * (1.5e+04f * fTemp151 + 5e+03f));
			float fTemp153 = 1.0f / fTemp152;
			fRec29[0] = fTemp75 * fTemp151 - (fRec29[2] * ((fTemp153 + -1.4142135f) / fTemp152 + 1.0f) + 2.0f * fRec29[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp152))) / ((fTemp153 + 1.4142135f) / fTemp152 + 1.0f);
			float fTemp154 = (fRec29[2] + fRec29[0] + 2.0f * fRec29[1]) / ((1.0f / fTemp150 + 1.4142135f) / fTemp150 + 1.0f);
			fVec13[IOTA0 & 4095] = fTemp154;
			float fTemp155 = fConst3 * (fTemp149 - fTemp65);
			int iTemp156 = int(fTemp155);
			float fTemp157 = std::floor(fTemp155);
			float fTemp158 = std::sqrt(fTemp79 + mydsp_faustpower2_f(fSlow3 * (fTemp80 + -1.0f - fSlow1)));
			float fTemp159 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp158 + 2.0f)) + 5e+03f));
			float fTemp160 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp79 + mydsp_faustpower2_f(fSlow3 * (fTemp80 - fSlow19))) + 2.0f));
			float fTemp161 = std::tan(fConst4 * (1.5e+04f * fTemp160 + 5e+03f));
			float fTemp162 = 1.0f / fTemp161;
			fRec30[0] = fTemp88 * fTemp160 - (fRec30[2] * ((fTemp162 + -1.4142135f) / fTemp161 + 1.0f) + 2.0f * fRec30[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp161))) / ((fTemp162 + 1.4142135f) / fTemp161 + 1.0f);
			float fTemp163 = (fRec30[2] + fRec30[0] + 2.0f * fRec30[1]) / ((1.0f / fTemp159 + 1.4142135f) / fTemp159 + 1.0f);
			fVec14[IOTA0 & 4095] = fTemp163;
			float fTemp164 = fConst3 * (fTemp158 - fTemp78);
			int iTemp165 = int(fTemp164);
			float fTemp166 = std::floor(fTemp164);
			float fTemp167 = std::sqrt(fTemp92 + mydsp_faustpower2_f(fSlow3 * (fTemp93 + -1.0f - fSlow1)));
			float fTemp168 = fConst3 * (fTemp167 - fTemp91);
			float fTemp169 = std::floor(fTemp168);
			float fTemp170 = std::tan(fConst4 * (1.5e+04f * mydsp_faustpower2_f(2.0f / (fTemp167 + 2.0f)) + 5e+03f));
			float fTemp171 = mydsp_faustpower2_f(2.0f / (std::sqrt(fTemp92 + mydsp_faustpower2_f(fSlow3 * (fTemp93 - fSlow19))) + 2.0f));
			float fTemp172 = std::tan(fConst4 * (1.5e+04f * fTemp171 + 5e+03f));
			float fTemp173 = 1.0f / fTemp172;
			fRec31[0] = fTemp99 * fTemp171 - (fRec31[2] * ((fTemp173 + -1.4142135f) / fTemp172 + 1.0f) + 2.0f * fRec31[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp172))) / ((fTemp173 + 1.4142135f) / fTemp172 + 1.0f);
			float fTemp174 = (fRec31[2] + fRec31[0] + 2.0f * fRec31[1]) / ((1.0f / fTemp170 + 1.4142135f) / fTemp170 + 1.0f);
			fVec15[IOTA0 & 4095] = fTemp174;
			int iTemp175 = int(fTemp168);
			output1[i0] = FAUSTFLOAT(fVec9[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp120))))) & 4095] * (fTemp121 + (1.0f - fTemp119)) + fVec8[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp111))))) & 4095] * (fTemp112 + (1.0f - fTemp110)) + fVec10[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp129))))) & 4095] * (fTemp130 + (1.0f - fTemp128)) + fVec11[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp138))))) & 4095] * (fTemp139 + (1.0f - fTemp137)) + fVec12[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp147))))) & 4095] * (fTemp148 + (1.0f - fTemp146)) + fVec13[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp156))))) & 4095] * (fTemp157 + (1.0f - fTemp155)) + fVec14[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp165))))) & 4095] * (fTemp166 + (1.0f - fTemp164)) + (fTemp168 - fTemp169) * fVec15[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp175 + 1))))) & 4095] + fVec15[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp175))))) & 4095] * (fTemp169 + (1.0f - fTemp168)) + (fTemp164 - fTemp166) * fVec14[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp165 + 1))))) & 4095] + (fTemp155 - fTemp157) * fVec13[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp156 + 1))))) & 4095] + (fTemp146 - fTemp148) * fVec12[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp147 + 1))))) & 4095] + (fTemp137 - fTemp139) * fVec11[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp138 + 1))))) & 4095] + (fTemp128 - fTemp130) * fVec10[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp129 + 1))))) & 4095] + (fTemp119 - fTemp121) * fVec9[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp120 + 1))))) & 4095] + (fTemp110 - fTemp112) * fVec8[(IOTA0 - int(std::min<float>(fSlow4, float(std::max<int>(0, iTemp111 + 1))))) & 4095]);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
	...
	FAUST_ADDHORIZONTALSLIDER("0/x", fHslider17, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("0/y", fHslider16, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("1/x", fHslider15, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("1/y", fHslider14, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("2/x", fHslider13, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("2/y", fHslider12, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("3/x", fHslider11, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("3/y", fHslider10, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("4/x", fHslider9, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("4/y", fHslider8, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("5/x", fHslider7, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("5/y", fHslider6, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("6/x", fHslider5, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("6/y", fHslider4, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("7/x", fHslider2, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("7/y", fHslider0, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Globals/moduleID", fHslider1, 0.0f, 0.0f, 7.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("Globals/spacing", fHslider3, 0.2f, 0.05f, 0.45f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, 0/x, "0/x", fHslider17, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 0/y, "0/y", fHslider16, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 1/x, "1/x", fHslider15, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 1/y, "1/y", fHslider14, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 2/x, "2/x", fHslider13, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 2/y, "2/y", fHslider12, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 3/x, "3/x", fHslider11, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 3/y, "3/y", fHslider10, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 4/x, "4/x", fHslider9, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 4/y, "4/y", fHslider8, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 5/x, "5/x", fHslider7, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 5/y, "5/y", fHslider6, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 6/x, "6/x", fHslider5, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 6/y, "6/y", fHslider4, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 7/x, "7/x", fHslider2, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, 7/y, "7/y", fHslider0, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, moduleID, "Globals/moduleID", fHslider1, 0.0f, 0.0f, 7.0f, 1.0f) \
		p(HORIZONTALSLIDER, spacing, "Globals/spacing", fHslider3, 0.2f, 0.05f, 0.45f, 0.01f) \
